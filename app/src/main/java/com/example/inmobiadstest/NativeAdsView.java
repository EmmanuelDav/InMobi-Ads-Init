...
public class NativeAdsView extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initSDK(){
        ...
        InMobiSdk.init(this, "5e976de4730046a48ccd397ed5ad298f", consentObject);
        InMobiSdk.setLogLevel(InMobiSdk.LogLevel.DEBUG);
    }

    private View loadAdIntoView(@NonNull final InMobiNative inMobiNative) {
        Log.d(TAG, "loadAdIntoView");
        View adView = LayoutInflater.from(this).inflate(R.layout.ad_item_list, null);
        ...
        content.addView(inMobiNative.getPrimaryViewOfWidth(this, content, mContainer, displayMetrics.widthPixels));
    ...
    NativeAdEventListener adListener = new NativeAdEventListener() {
        @Override
        public void onAdLoadSucceeded(@NonNull InMobiNative pInMobiNative, @NonNull AdMetaInfo pAdMetaInfo) {
            Log.d(TAG, "onAdLoadSucceeded: ");
            View view = loadAdIntoView(pInMobiNative);
            if(view == null){
    ...
    private void createNativeAds(){
        ...
        nativeAd = new InMobiNative(this, 1553753205807L, adListener);
